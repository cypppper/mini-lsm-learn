...
impl BlockMeta {
    ...
    pub fn encode_block_meta(block_meta: &[BlockMeta], buf: &mut Vec<u8>) {
        ...
        for meta in block_meta {
            ...
            encode_bytes.put_u16(meta.first_key.len() as u16);
            encode_bytes.put(meta.first_key.raw_ref());
            encode_bytes.put_u16(meta.last_key.len() as u16);
            encode_bytes.put(meta.last_key.raw_ref());
        }
